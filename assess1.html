...
<body>
    ...
    <form action="assessment_form/assess1_form.php" method="POST"> <!--This is the start of the form. It will uses assess1_form.php to push data to the database-->
		<div class="Container">
            <div class="housing">
                <div>
    ...
    <button type="submit" class="save-button" id="submit">Save and Close</button>
</form>
